...
* Draft e-mail for Introduction to Git
  ...
  In order to move to the next phase of the internship it is
  necessary for you to do the following:

  + Install Git Bash on your Laptops/ PCs.
  + Learn how to use [[https://guides.github.com/activities/hello-world/][GitHub]] and how to work with Github.
  
  
  You must then:  
  Sign up and Sign in to  GitHub.
  [[https://help.github.com/articles/create-a-repo/][Create]] a new repository.
