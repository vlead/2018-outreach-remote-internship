...
* Process
  ...
  + Part 2 : Fixing issues/bugs in the [[https://github.com/virtual-labs/][Virtual Labs]]
    repository.
  + Part 3 : Validating fixed issue. 
 *Note : Make sure that you have accepted the invitation
 that we have sent to your mail*
 ...
 * Steps for the validating an issue
   + Step 1 - Every fixed issue/bug
     ...
     validatos must review the fixes and respond on the
     same issue with the comment *Validated - 1* or *Validated - 2*. 
